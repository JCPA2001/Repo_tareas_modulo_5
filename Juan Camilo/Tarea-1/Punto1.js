...
// Utiliza la función mappara generar un nuevo array de libros que solo tenga las propiedades tituloy autor, cuando imprimas tu nuevo array debe quedar de la siguiente forma:
//  [
...
const nuevoArrayLibros = libros.map(libro => ({
    titulo: libro.titulo,
    autor: libro.autor
 }));
